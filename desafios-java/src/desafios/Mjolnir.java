 ...
 * <p>
 * Escreva um programa que, dado um nome, e a força, em Newtons, aplicado ao tentar levantar o Mjölnir, informar se
 * a pessoa conseguiu ou não levantá-lo.
 * <p>
 * Entrada
 * Um número inteiro C será informado, que será a quantidade de casos de teste. Cada caso de teste inicia com uma
 * palavra, que é o primeiro nome de quem está tentando levantar o Mjölnir, e um inteiro N (1 ≤ N ≤ 25000), indicando
 * a força aplicada para cima, em Newtons, ao puxar o martelo, de modo a tentar levantá-lo.
 * <p>
 * Saída
